      ...
      <div className="grid md:grid-cols-5 w-full grid-cols-2 h-full mb-10 gap-4 md:gap-10 ">
        {products.slice(0, 5).map((product) => (
          ...
          >
            ...
            <h3 className="mt-1 text-lg md:text-xl font-medium">{product.name}</h3>
            ...
            <div className="flex justify-between items-center relative  mt-2">
              ...
              <div onClick={(e)=> handleAddToCart(e,product)}  className="bg-red-700 absolue flex items-center hover:w-28 justify-center group w-7 h-7 md:w-8 md:h-8 text-sm md:p-2 text-white rounded-full  transition-all duration-100 hover:scale-105">

      ...
      <nav className="flex flex-col bg-gray-50 gap-4 py-4 shadow-md sticky top-0 justify-center z-20">
        <div className="flex items-center justify-center w-full md:gap-8 gap-4">
          ...
          <form onSubmit={handleSearch} className="flex relative items-center">
            <input
              className="md:w-[53vw] w-[51vw] flex-1 border-2 p-2 rounded-md outline-none"
              type="text"
            ...
            <button type="submit" className="cursor-pointer absolute right-3">
              <CiSearch className=" text-red-700" size={20} />
            </button>
          </form>
          ...
          {user && ( // if user is there then this code will execute
            <div className="flex items-center">
              ...
              <button
                className="ml-4 bg-red-600 px-4 py-1 text-white rounded-md cursor-pointer"

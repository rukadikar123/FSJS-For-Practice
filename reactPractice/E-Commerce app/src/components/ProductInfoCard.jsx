    ...
    <div className="md:my-10 my-2">
      <div className="flex md:flex-row flex-col justify-center items-center gap-10 md:gap-40">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="bg-red-600 text-white w-2/3 text-lg px-2 py-1" onClick={handleAddToCart}>Add To Cart</button>
      ...
      <div className="flex flex-col gap-4 mt-10 ml-8 md:ml-96">
        ...
        <p className="md:text-xl text-md">Product Description will goes here...</p>
      </div>
    </div>
  );
}

                ...
                <tbody>
                  {cart?.map((item) => (
                    <tr key={item?.id} className="">
                      <td className="md:px-4 px-1 py-2 md:text-xl text-xs font-semibold flex flex-col md:flex-row md:items-center gap-1 md:gap-10 border border-gray-300">
                        <img className="md:h-28 h-10 w-10 md:w-24" src={item?.image} alt="" />
                        {item?.title}
                      </td>
                      ...
                      <td className="md:px-4 px-1 py-2 text-center border border-gray-300">
                        <span onClick={()=>handleDecrease(item)} className="border border-gray-300 px-1 cursor-pointer font-semibold md:text-xl text-sm ">
                          -
                        </span>
                        <span className="border border-gray-300 px-1 cursor-pointer font-semibold text-sm md:text-xl">
                          {item?.quantity}
                        </span>
                        <span onClick={()=>handleIncrease(item)} className="border border-gray-300 px-1 cursor-pointer font-semibold md:text-xl text-sm">
                          +
                        </span>
                      </td>
                      ...
                      <td className="md:px-4 px-0 py-2 text-center border  border-gray-300">
                        <FaTrashAlt onClick={()=>handleRemove(item)} size={20} className="ml-6 cursor-pointer" />
                      </td>
                    </tr>
                  ))}
                </tbody>

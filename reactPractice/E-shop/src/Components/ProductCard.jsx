        ...
        {products?.map((product) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <div  className="bg-red-700 absolue flex items-center hover:w-28 justify-center group w-7 h-7 md:w-8 md:h-8 text-sm md:p-2 text-white rounded-full  transition-all duration-100 hover:scale-105">

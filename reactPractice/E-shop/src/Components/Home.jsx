          ...
          <ul className="flex flex-col md:gap-2 gap-1 pb-2">
            {categories?.map((category, idx) => (
              <li
                ...
                key={idx}
              >
                <Link to={`/category/${category}`} className="flex md:text-md text-sm items-center md:gap-2 gap-1 cursor-pointer transform transition-transform duration-100 hover:scale-105">

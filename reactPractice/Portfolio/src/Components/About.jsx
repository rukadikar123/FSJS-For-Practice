...
function About() {
  return (
    <div className="my-10 mx-20">
      ...
      <p className="text-xl text-gray-900 font-medium my-4">
      ...
      <h1 className="text-4xl mt-8 text-green-700 font-semibold">Education</h1>
      ...
      <p className="mt-2 text-xl text-gray-900 font-medium">
      ...
      <h1 className="text-4xl mt-8 text-green-700 font-semibold">
        Skills & Expertise
      </h1>
      <p className="mt-4 text-xl text-gray-900 font-medium">
